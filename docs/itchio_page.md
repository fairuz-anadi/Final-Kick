...
> One kick. One chance. Rewind, aim again, and wake the machine up for good.

## Description

You're the last worker in a factory that forgot how to move.

All you have is a busted device strapped to your leg — the last thing an old
man built before he sat down and let the room go dark. It does one thing: it
lets you kick something *really* hard — and for a few seconds after, scrub
back through time like dragging a video timeline, watching a ghost of what
almost happened.
...
- **Ball evolution** — the ball earns a new skin every room: chrome to cyan to molten to gold to white-hot, growing rings, spikes and a hotter trail until the final dark-chrome, red-core form
...
- [ ] 5-7 screenshots: the opening cinematic, a mid-chain explosion, the rewind overlay active, an Overcharge/Final-Kick moment, the Twin Circuits corridors, a late-game ball skin (gold/white-hot), the spectacle cam moment, the title screen
